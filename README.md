...
[Developers documentation](https://platform.youwol.com/applications/@youwol/cdn-explorer/latest?package=@youwol/npm-explorer)
    ...
    customization = Customization(
        middlewares = [
            FlowSwitcherMiddleware(
                ...
                oneOf = [
                    WebpackDevServerSwitch(packageName="@youwol/todo-app-ts", port=3019),
                ]
            )
        ]
    )
