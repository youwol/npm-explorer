...
[Running app.](https://platform.youwol.com/applications/@youwol/npm-explorer/latest)

[Online user-guide](https://l.youwol.com/doc/@youwol/npm-explorer)

[Developers documentation](https://platform.youwol.com/applications/@youwol/cdn-explorer/latest?package=@youwol/npm-explorer&tab=doc)

[Package on npm](https://www.npmjs.com/package/@youwol/npm-explorer)

[Source on GitHub](https://github.com/youwol/npm-explorer)
    ...
    customization = Customization(
        middlewares = [
            FlowSwitcherMiddleware(
                ...
                oneOf = [
                    WebpackDevServerSwitch(packageName="@youwol/npm-explorer", port=3019),
                ]
            )
        ]
    )
...
the application can be accessed from [here](http://localhost:2000/applications/@youwol/npm-explorer/latest)
